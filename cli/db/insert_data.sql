...
INSERT INTO customers
    (`name`, phone, email, passwd, addressID)
VALUES
    ('Anish',  1234567890, 'anish22075@iiitd.ac.in',  "password_strong", 3),
    ('Adarsh', 2345678901, 'adarsh22024@iiitd.ac.in', "password_strong", 4);

INSERT INTO carts
    (customerID, bookID, qty)
VALUES
    (1, 4, 2),
    (1, 8, 3),
    (1, 1, 1),
